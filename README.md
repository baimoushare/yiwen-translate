<div align="center">
  ...
  <p>一款 Windows 屏幕翻译工具，支持截图翻译、实时翻译和原位覆盖翻译。</p>
...
译文是一款面向 Windows 的屏幕翻译工具，支持截图翻译、实时翻译、划词翻译和文字翻译。
...
| ![截图翻译3-前.png](docs/images/截圖翻譯3-前.png) | ![截图翻译3-后.png](docs/images/截圖翻譯3-後.png) |
